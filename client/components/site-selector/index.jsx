...
const SiteSelector = React.createClass( {
	propTypes: {
		...
		getSiteAndRun: React.PropTypes.func.isRequired,
	...
	computeHighlightedSite() {
		...
		if ( this.state.isKeyboardEngaged ) {
			...
			// @FIXME
			highlightedSite = this.props.getSiteAndRun( this.lastMouseHover ) || this.lastMouseHover;
	...
	getPathnameForSite( slug ) {
		const site = this.props.getSiteAndRun( slug );
		console.warn( 'getSiteAndRun', site, slug );
...
export default connect( ( state ) => {
	...
	return {
		...
		getSiteAndRun: getSite.bind( null, state ),
